...
- [nowork-studio/NotFair](https://github.com/nowork-studio/NotFair) 📇 ☁️ - Open-source Claude Code skills for SEO, Google Ads, and Meta Ads. Connects to live data via Google Ads MCP, Meta Ads MCP, Google Search Console MCP, and Google Analytics (GA4) MCP to run audits, keyword research, and campaign management.
